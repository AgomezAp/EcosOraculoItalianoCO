...
Risposta dell'astrologa (assicurati di completare TUTTA la tua analisi astrologica prima di terminare):`;
                ...
                console.log(`✅ Analisi della tabella di nascita generata con successo con ${usedModel} (${text.length} caratteri)`);
            ...
            try {
                res.json({
                    ...
                    astrologer: {
                        ...
                        description: "Astrologa specializzata nella creazione e interpretazione di tabelle natali precise basate su posizioni planetarie del momento della nascita",
                        services: [
