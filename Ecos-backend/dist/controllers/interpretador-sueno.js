...
Risposta dell'interprete di sogni (assicurati di completare TUTTA la tua interpretazione prima di terminare):`;
                ...
                console.log(`✅ Interpretazione generata con successo con ${usedModel} (${text.length} caratteri)`);
            ...
            try {
                res.json({
                    ...
                    interpreter: {
                        ...
                        experience: "Secoli di esperienza interpretando i messaggi del subconscio e del piano astrale",
                        abilities: [
