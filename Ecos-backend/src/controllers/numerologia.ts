...
- Se menzioni che stai per calcolare numeri, ${
        shouldGiveFullResponse
...
Ricorda: Sei una guida numerologica saggia ma ACCESSIBILE che ${
      isFullResponse
        ? "rivela i segreti dei numeri in modo completo"
        : "intriga sui misteri numerici che hai rilevato"
    }. Parla come un'amica curiosa ed entusiasta. ${
      isFullResponse
  ...
  private handleError(error: any, res: Response): void {
    ...
    let statusCode = 500;
    let errorMessage =
      "Le energie numeriche sono temporaneamente disturbate. Per favore, riprova.";
    ...
    try {
      res.json({
        ...
        numerologist: {
          ...
          description:
            "Numerologa ancestrale specializzata nel decifrare i misteri dei numeri e la loro influenza nella vita",
          services: [
